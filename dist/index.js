...
(() => {
  ...
  // node_modules/.pnpm/gsap@3.13.0/node_modules/gsap/all.js
  var gsapWithCSS = gsap.registerPlugin(CSSPlugin) || gsap;
  var TweenMaxWithCSS = gsapWithCSS.core.Tween;

  // src/animations/bannerwithgsap.js
  var Banner = () => {
    ...
    mm.add(
      ...
      (context3) => {
        let { isDesktop, isMobile } = context3.conditions;
  ...
  var bannerwithgsap_default = Banner;

  // src/animations/pallax.js
  var pallax = () => {
    gsapWithCSS.registerPlugin(ScrollTrigger2);
    const scrollTrigger = {
      trigger: ".home-hero",
    ...
    animations.forEach(({ target, from, to }) => {
      gsapWithCSS.fromTo(target, from, { ...to, scrollTrigger });
    });
  };
